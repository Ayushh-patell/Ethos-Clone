...
const HomeSectionRight = ({ src, topic, title, text1, text2, buttonText }) => {
  const {Darkmode} = useContext(DarkModeContext)

  return (
    <section className={` flex lg:flex-row items-center flex-col ${Darkmode ? " bg-dark_gray-900 text-white":" bg-white"} lg:px-28 md:px-16 px-10 py-6 md:gap-6`}>
